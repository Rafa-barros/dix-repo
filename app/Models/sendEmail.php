    ...
    public function mail($email, $id, $codigo){
        ...
        try {
            ...
            box-shadow: -1px 10px 20px -6px rgba(0,0,0,0.75); margin-left: auto; margin-right: auto; border: 1px #F7F7F7 solid; border-radius: 5%;">
                ...
                <p style="font-family: Verdana; font-size: 9px; text-align: center; text-decoration: underline;"><a href="http://dix.net.br/verificarconta?id=' . $id . '&email=' . $email . '&codigo=' . $codigo . '"></a>http://dix.net.br/verificarconta?id=' . $id . '&email=' . $email . '&codigo=' . $codigo . '</div></p>
            </div>';
    ...
    public function mailSenha($email, $id, $codigo){
        ...
        try {
            ...
            box-shadow: -1px 10px 20px -6px rgba(0,0,0,0.75); margin-left: auto; margin-right: auto; border: 1px #F7F7F7 solid; border-radius: 5%;">
                ...
                <p style="text-align: center; font-family: Verdana; font-size: 10px; margin-top: 20vh;">Ou então, clique no link abaixo</p>
                <p style="font-family: Verdana; font-size: 9px; text-align: center; text-decoration: underline;"><a href="http://dix.net.br/recuperarsenha?id=' . $id . '&email=' . $email . '&codigo=' . $codigo . '"></a>http://dix.net.br/recuperarsenha?id=' . $id . '&email=' . $email . '&codigo=' . $codigo . '</div></p>
            </div>';
