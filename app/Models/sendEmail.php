...
class sendEmail{
    ...
    public function mail($email, $id, $codigo){
        ...
        try {
            ...
            $mail->Body    = '<div style=" background-color: #F7F7F7; width: 97vw; height: 300px; -webkit-box-shadow: -1px 10px 20px -6px rgba(0,0,0,0.75); -moz-box-shadow: -1px 10px 20px -6px rgba(0,0,0,0.75); box-shadow: -1px 10px 20px -6px rgba(0,0,0,0.75); margin-left: auto; margin-right: auto; border: 1px #F7F7F7 solid; border-radius: 5%; " class="card"> <img style="margin-left: 12vw;" height="100px" width="100px" src="http://dix.net.br/app/View/assets/css/img/logo_blue.png"> <h1 style="text-align: center; font-family: Verdana; color:#0069d9">Ativação de conta</h1> <p style="text-align: center; font-family: Verdana;">Para ativação da sua conta, insira esse código:</p><div style="margin-top: 15vh; width: 150px; height: 7vh; background-color: #cccccc; border: 1px #b6b6b6 solid; margin-left: 10vw; display: flex; align-items: center; justify-content: center"> <a style="font-family: Verdana; font-size: 25px;">' . $codigo . '</a> </div><p style="text-align: center; font-family: Verdana; font-size: 10px; margin-top: 20vh;">Ou então, clique no link abaixo</p><p style="font-family: Verdana; font-size: 9px; text-align: center; text-decoration: underline;"><a href="https://dix.net.br/verificarconta?id=' . $id . '&email=' . $email . '&codigo=' . $codigo . '"></a>https://dix.net.br/verificarconta?id=' . $id . '&email=' . $email . '&codigo=' . $codigo . '</div></p></div>';
