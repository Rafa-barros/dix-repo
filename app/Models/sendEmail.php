    ...
    public function mail($email, $id, $codigo){
        ...
        try {
            ...
            box-shadow: -1px 10px 20px -6px rgba(0,0,0,0.75); margin-left: auto; margin-right: auto; border: 1px #F7F7F7 solid; border-radius: 5%;">
                ...
                <div style="margin-top: 15vh; width: 10vw; height: 7vh; background-color: #cccccc; border: 1px #b6b6b6 solid; margin-left: 10vw; display: flex; align-items: center; justify-content: center">
