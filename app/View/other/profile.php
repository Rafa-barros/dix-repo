     ...
     <div class="card" id=<?php echo("\"" . $profilePosts->posts[$j]['id'] . "\""); ?>>
                ...
                <div class="card-bot">
                    ...
                    <div class="interactive">
                        <div class="like">
                            <button class="btn-like" style="color: <?php if($profilePosts->posts[$j]['liked'] == 1) { echo("rgb(218, 51, 51)" . "\""); } else { echo ("rgb(0, 0, 0)" . "\"");}?>><span><i style="color: unset" class="fas fa-fire-alt"></i> Curtir</span> </button>
                        </div>
                        <div class="donate">
