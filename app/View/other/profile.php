                    ...
                    <div class="modal-container">
                        <div class="center">
                            <div>
                                ...
                                <a href="#" class="btn btn-primary mb-3 btn-preco-post" style="color: #FAFAFA;font-weight: 500;margin-left: 120px;width: 128px;">R$12</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modal-config" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" style="margin-top: 84px;" role="document">
    ...
    <div class="profile-bottom">
     ...
     <div class="card <?php if($profilePosts->posts[$j]['allowView']) echo('pago '.$profilePosts->posts[$j]['price']) ?>" id=<?php echo("\"" . $profilePosts->posts[$j]['id'] . "\""); ?>>
                <div class="card-top">
                <?php if(base64_decode($_COOKIE['cUser']) == $email){ ?>
